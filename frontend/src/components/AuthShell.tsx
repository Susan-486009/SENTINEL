      ...
      <div className="relative hidden overflow-hidden bg-primary p-10 text-primary-foreground lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative max-w-md">
          ...
          <p className="mt-4 text-primary-foreground/75">
            Used by students, faculty, and administration to handle academic and campus issues with
            care, transparency, and accountability.
          </p>
          <ul className="mt-8 space-y-3 text-sm">
            <li className="flex items-center gap-3">
              <ShieldCheck className="h-4 w-4" /> Verified institutional access
            </li>
            <li className="flex items-center gap-3">
              <Lock className="h-4 w-4" /> Confidential by design
            </li>
            <li className="flex items-center gap-3">
              <EyeOff className="h-4 w-4" /> Anonymous reporting available
            </li>
          </ul>
        </div>
