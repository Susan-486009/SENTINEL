...
import { Plus, ArrowUpRight, Clock, CheckCircle2, AlertCircle, Loader2 } from "lucide-react";
...
function DashboardIndex() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div>
        <h2 className="font-display text-3xl font-semibold tracking-tight">Welcome back, {user?.name?.split(' ')[0] || "User"}</h2>
        <p className="mt-1 text-muted-foreground">Here is what's happening with your reports today.</p>
      </div>
