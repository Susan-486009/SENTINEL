...
function CasesPage() {
              ...
              active.files.map((f, i) => (
                <li key={i}>
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center justify-between rounded-xl border border-border bg-slate-950/40 hover:bg-slate-900/60 px-4 py-3 text-xs transition-all duration-300 group shadow-sm animate-in fade-in"
                  >
  ...
  return (
    <AppShell nav={adminNav} title="Cases">
      ...
      <div className="flex h-[calc(100vh-8.5rem)] w-full gap-6 overflow-hidden min-h-0 relative select-none">
        ...
        >
          <AnimatePresence mode="wait">
            {active ? (
              ...
              <div className="flex flex-col items-center justify-center h-full w-full rounded-2xl border border-border bg-card text-center p-6 bg-slate-900/5 select-none animate-in fade-in">
